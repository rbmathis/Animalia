...
|------------|-----------|---------|
| [Breadcrumb Instructions](.github/instructions/breadcrumb.instructions.md) | `**/breadcrumb.md` | YAML metadata structure, navigation patterns, taxonomy-level field conventions |
| [C# File Instructions](.github/instructions/csharp.instructions.md) | `**/*.cs` | Namespace conventions, file type patterns, inheritance hierarchy, common patterns |
| [Interface Instructions](.github/instructions/interface.instructions.md) | `**/I[A-Z]*.cs` | Interface contracts, behavioral patterns, genus/family interface design |
| [Species Instructions](.github/instructions/species.instructions.md) | `**/*_*.cs` | Species file structure, property definitions, enrichment flags, conservation status |
...
|-------|---------|------------|
| [**Pet Lookup**](.github/skills/pet-lookup/SKILL.md) | Find species commonly kept as pets | Searching for domestic/pet animals, comparing amenability-to-captivity across families |
| [**Species Lookup**](.github/skills/species-lookup/SKILL.md) | Find specific species by name, common name, or TaxId | Locating individual species, checking properties like conservation status or lifespan |
| [**Interface Validation**](.github/skills/interface-validation/SKILL.md) | Validate that species and genus classes implement required interfaces | Ensuring interface compliance across large taxa, bulk validation tasks |
| [**Breadcrumb Traversal**](.github/skills/breadcrumb-traversal/SKILL.md) | Use breadcrumb metadata for efficient navigation | Finding related taxa, cross-cutting queries, avoiding deep file scans |
| [**Breadcrumb Creation**](.github/skills/breadcrumb-creation/SKILL.md) | Generate and maintain breadcrumb metadata | Creating new taxa, updating taxonomy levels, aggregating species data |
...
**Breadcrumb Navigation**: This repo's breadcrumb metadata approach was inspired by [@ekuris-repos](https://github.com/ekuris-repos)'s excellent **markdown-frontmatter** pattern in the [Swarm](https://github.com/ekuris-repos/Swarm) project. Their implementation demonstrates how YAML frontmatter can elegantly organize and aggregate hierarchical data across large codebases.
