using AnimalKingdom.root.Metazoa.Chordata.Leptocardii;

namespace AnimalKingdom.root.Metazoa.Chordata.Leptocardii.Amphioxiformes;

/// <summary>
/// Abstract class for Amphioxiformes (order).
/// NCBI TaxId: 2682553
/// </summary>
public abstract class Amphioxiformes : Leptocardii, IAmphioxiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Amphioxiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 2682553;
