...
namespace AnimalKingdom.root.Metazoa.Chordata.Ascidiacea.Aplousobranchia;

/// <summary>
/// Abstract class for Aplousobranchia (order).
/// NCBI TaxId: 32436
/// </summary>
public abstract class Aplousobranchia : Ascidiacea, IAplousobranchia
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Aplousobranchia";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 32436;
