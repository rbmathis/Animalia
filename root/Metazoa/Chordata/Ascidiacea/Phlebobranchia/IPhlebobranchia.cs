namespace AnimalKingdom.root.Metazoa.Chordata.Ascidiacea.Phlebobranchia;

/// <summary>
/// Interface defining characteristics of Phlebobranchia (order).
/// </summary>
public interface IPhlebobranchia
{
    /// <inheritdoc />
