...
/// <summary>
/// Abstract class for Phlebobranchia (order).
/// NCBI TaxId: 7716
/// </summary>
public abstract class Phlebobranchia : Ascidiacea, IPhlebobranchia
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Phlebobranchia";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 7716;
