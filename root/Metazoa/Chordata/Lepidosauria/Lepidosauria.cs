...
/// <summary>
/// Abstract class for Lepidosauria (class).
/// NCBI TaxId: 8504
/// </summary>
public abstract class Lepidosauria : Chordata, ILepidosauria
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Lepidosauria";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "class";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8504;
