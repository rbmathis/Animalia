using AnimalKingdom.root.Metazoa.Chordata.Hyperoartia;

namespace AnimalKingdom.root.Metazoa.Chordata.Hyperoartia.Petromyzontiformes;

/// <summary>
/// Abstract class for Petromyzontiformes (order).
/// NCBI TaxId: 7745
/// </summary>
public abstract class Petromyzontiformes : Hyperoartia, IPetromyzontiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Petromyzontiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 7745;
