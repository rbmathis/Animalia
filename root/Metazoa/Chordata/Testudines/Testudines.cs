...
namespace AnimalKingdom.root.Metazoa.Chordata.Testudines;

/// <summary>
/// Abstract class for Testudines (order).
/// NCBI TaxId: 8459
/// </summary>
public abstract class Testudines : Chordata, ITestudines
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Testudines";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8459;
