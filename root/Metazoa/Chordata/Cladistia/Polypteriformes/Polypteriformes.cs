using AnimalKingdom.root.Metazoa.Chordata.Cladistia;

namespace AnimalKingdom.root.Metazoa.Chordata.Cladistia.Polypteriformes;

/// <summary>
/// Abstract class for Polypteriformes (order).
/// NCBI TaxId: 8288
/// </summary>
public abstract class Polypteriformes : Cladistia, IPolypteriformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Polypteriformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8288;
