...
namespace AnimalKingdom.root.Metazoa.Chordata.Thaliacea.Doliolida;

/// <summary>
/// Abstract class for Doliolida (order).
/// NCBI TaxId: 76838
/// </summary>
public abstract class Doliolida : Thaliacea, IDoliolida
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Doliolida";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 76838;
