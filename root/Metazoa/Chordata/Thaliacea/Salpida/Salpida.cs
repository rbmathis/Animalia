...
/// <summary>
/// Abstract class for Salpida (order).
/// NCBI TaxId: 30307
/// </summary>
public abstract class Salpida : Thaliacea, ISalpida
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Salpida";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 30307;
