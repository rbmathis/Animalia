...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Notoungulata;

/// <summary>
/// Abstract class for Notoungulata (order).
/// NCBI TaxId: 1563120
/// </summary>
public abstract class Notoungulata : Mammalia, INotoungulata
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Notoungulata";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1563120;
