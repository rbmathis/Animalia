...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Rodentia;

/// <summary>
/// Abstract class for Rodentia (order).
/// NCBI TaxId: 9989
/// </summary>
public abstract class Rodentia : Mammalia, IRodentia
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Rodentia";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9989;
