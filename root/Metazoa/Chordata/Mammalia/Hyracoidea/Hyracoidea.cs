...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Hyracoidea;

/// <summary>
/// Abstract class for Hyracoidea (order).
/// NCBI TaxId: 9810
/// </summary>
public abstract class Hyracoidea : Mammalia, IHyracoidea
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Hyracoidea";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9810;
