...
/// <summary>
/// Abstract class for Proboscidea (order).
/// NCBI TaxId: 9779
/// </summary>
public abstract class Proboscidea : Mammalia, IProboscidea
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Proboscidea";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9779;
