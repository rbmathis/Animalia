...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Peramelemorphia;

/// <summary>
/// Abstract class for Peramelemorphia (order).
/// NCBI TaxId: 38611
/// </summary>
public abstract class Peramelemorphia : Mammalia, IPeramelemorphia
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Peramelemorphia";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 38611;
