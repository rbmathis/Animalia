...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Didelphimorphia;

/// <summary>
/// Abstract class for Didelphimorphia (order).
/// NCBI TaxId: 38605
/// </summary>
public abstract class Didelphimorphia : Mammalia, IDidelphimorphia
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Didelphimorphia";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 38605;
