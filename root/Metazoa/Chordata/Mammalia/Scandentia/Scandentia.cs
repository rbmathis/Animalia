...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Scandentia;

/// <summary>
/// Abstract class for Scandentia (order).
/// NCBI TaxId: 9392
/// </summary>
public abstract class Scandentia : Mammalia, IScandentia
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Scandentia";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9392;
