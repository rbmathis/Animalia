...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Monotremata;

/// <summary>
/// Abstract class for Monotremata (order).
/// NCBI TaxId: 9255
/// </summary>
public abstract class Monotremata : Mammalia, IMonotremata
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Monotremata";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9255;
