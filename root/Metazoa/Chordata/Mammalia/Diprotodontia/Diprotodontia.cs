...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Diprotodontia;

/// <summary>
/// Abstract class for Diprotodontia (order).
/// NCBI TaxId: 38609
/// </summary>
public abstract class Diprotodontia : Mammalia, IDiprotodontia
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Diprotodontia";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 38609;
