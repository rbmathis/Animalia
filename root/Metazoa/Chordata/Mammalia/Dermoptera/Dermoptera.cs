...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Dermoptera;

/// <summary>
/// Abstract class for Dermoptera (order).
/// NCBI TaxId: 30656
/// </summary>
public abstract class Dermoptera : Mammalia, IDermoptera
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Dermoptera";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 30656;
