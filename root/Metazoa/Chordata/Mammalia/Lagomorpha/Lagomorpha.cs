...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Lagomorpha;

/// <summary>
/// Abstract class for Lagomorpha (order).
/// NCBI TaxId: 9975
/// </summary>
public abstract class Lagomorpha : Mammalia, ILagomorpha
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Lagomorpha";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9975;
