...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Microbiotheria;

/// <summary>
/// Abstract class for Microbiotheria (order).
/// NCBI TaxId: 38607
/// </summary>
public abstract class Microbiotheria : Mammalia, IMicrobiotheria
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Microbiotheria";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 38607;
