...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Pholidota;

/// <summary>
/// Abstract class for Pholidota (order).
/// NCBI TaxId: 9971
/// </summary>
public abstract class Pholidota : Mammalia, IPholidota
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Pholidota";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9971;
