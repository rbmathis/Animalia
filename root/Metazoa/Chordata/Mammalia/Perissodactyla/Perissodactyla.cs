...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Perissodactyla;

/// <summary>
/// Abstract class for Perissodactyla (order).
/// NCBI TaxId: 9787
/// </summary>
public abstract class Perissodactyla : Mammalia, IPerissodactyla
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Perissodactyla";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9787;
