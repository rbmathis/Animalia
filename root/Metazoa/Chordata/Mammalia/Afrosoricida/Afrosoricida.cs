...
/// <summary>
/// Abstract class for Afrosoricida (order).
/// NCBI TaxId: 3466516
/// </summary>
public abstract class Afrosoricida : Mammalia, IAfrosoricida
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Afrosoricida";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 3466516;
