...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Tubulidentata;

/// <summary>
/// Abstract class for Tubulidentata (order).
/// NCBI TaxId: 9815
/// </summary>
public abstract class Tubulidentata : Mammalia, ITubulidentata
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Tubulidentata";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9815;
