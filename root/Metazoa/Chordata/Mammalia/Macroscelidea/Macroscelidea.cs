...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Macroscelidea;

/// <summary>
/// Abstract class for Macroscelidea (order).
/// NCBI TaxId: 28734
/// </summary>
public abstract class Macroscelidea : Mammalia, IMacroscelidea
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Macroscelidea";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 28734;
