...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Notoryctemorphia;

/// <summary>
/// Abstract class for Notoryctemorphia (order).
/// NCBI TaxId: 38610
/// </summary>
public abstract class Notoryctemorphia : Mammalia, INotoryctemorphia
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Notoryctemorphia";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 38610;
