...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Chiroptera;

/// <summary>
/// Abstract class for Chiroptera (order).
/// NCBI TaxId: 9397
/// </summary>
public abstract class Chiroptera : Mammalia, IChiroptera
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Chiroptera";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9397;
