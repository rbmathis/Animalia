...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Dasyuromorphia;

/// <summary>
/// Abstract class for Dasyuromorphia (order).
/// NCBI TaxId: 38608
/// </summary>
public abstract class Dasyuromorphia : Mammalia, IDasyuromorphia
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Dasyuromorphia";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 38608;
