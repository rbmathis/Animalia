...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Sirenia;

/// <summary>
/// Abstract class for Sirenia (order).
/// NCBI TaxId: 9774
/// </summary>
public abstract class Sirenia : Mammalia, ISirenia
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Sirenia";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9774;
