...
/// <summary>
/// Abstract class for Litopterna (order).
/// NCBI TaxId: 1563124
/// </summary>
public abstract class Litopterna : Mammalia, ILitopterna
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Litopterna";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1563124;
