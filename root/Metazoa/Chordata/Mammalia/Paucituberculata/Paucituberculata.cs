...
/// <summary>
/// Abstract class for Paucituberculata (order).
/// NCBI TaxId: 38606
/// </summary>
public abstract class Paucituberculata : Mammalia, IPaucituberculata
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Paucituberculata";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 38606;
