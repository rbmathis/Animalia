...
/// <summary>
/// Abstract class for Eulipotyphla (order).
/// NCBI TaxId: 9362
/// </summary>
public abstract class Eulipotyphla : Mammalia, IEulipotyphla
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Eulipotyphla";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9362;
