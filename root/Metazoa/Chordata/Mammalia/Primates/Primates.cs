...
/// <summary>
/// Abstract class for Primates (order).
/// NCBI TaxId: 9443
/// </summary>
public abstract class Primates : Mammalia, IPrimates
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Primates";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9443;
