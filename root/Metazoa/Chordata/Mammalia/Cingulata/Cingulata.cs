...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Cingulata;

/// <summary>
/// Abstract class for Cingulata (order).
/// NCBI TaxId: 948951
/// </summary>
public abstract class Cingulata : Mammalia, ICingulata
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Cingulata";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 948951;
