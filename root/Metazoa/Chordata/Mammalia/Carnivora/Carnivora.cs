...
namespace AnimalKingdom.root.Metazoa.Chordata.Mammalia.Carnivora;

/// <summary>
/// Abstract class for Carnivora (order).
/// NCBI TaxId: 33554
/// </summary>
public abstract class Carnivora : Mammalia, ICarnivora
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Carnivora";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 33554;
