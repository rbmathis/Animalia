...
namespace AnimalKingdom.root.Metazoa.Chordata.Appendicularia.Copelata;

/// <summary>
/// Abstract class for Copelata (order).
/// NCBI TaxId: 2507557
/// </summary>
public abstract class Copelata : Appendicularia, ICopelata
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Copelata";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 2507557;
