...
namespace AnimalKingdom.root.Metazoa.Chordata.Chondrichthyes.Myliobatiformes;

/// <summary>
/// Abstract class for Myliobatiformes (order).
/// NCBI TaxId: 117851
/// </summary>
public abstract class Myliobatiformes : Chondrichthyes, IMyliobatiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Myliobatiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 117851;
