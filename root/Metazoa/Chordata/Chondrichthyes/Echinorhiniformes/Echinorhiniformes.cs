...
namespace AnimalKingdom.root.Metazoa.Chordata.Chondrichthyes.Echinorhiniformes;

/// <summary>
/// Abstract class for Echinorhiniformes (order).
/// NCBI TaxId: 118015
/// </summary>
public abstract class Echinorhiniformes : Chondrichthyes, IEchinorhiniformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Echinorhiniformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 118015;
