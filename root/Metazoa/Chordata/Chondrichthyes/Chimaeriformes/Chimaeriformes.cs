...
namespace AnimalKingdom.root.Metazoa.Chordata.Chondrichthyes.Chimaeriformes;

/// <summary>
/// Abstract class for Chimaeriformes (order).
/// NCBI TaxId: 7864
/// </summary>
public abstract class Chimaeriformes : Chondrichthyes, IChimaeriformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Chimaeriformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 7864;
