...
namespace AnimalKingdom.root.Metazoa.Chordata.Chondrichthyes.Carcharhiniformes;

/// <summary>
/// Abstract class for Carcharhiniformes (order).
/// NCBI TaxId: 30483
/// </summary>
public abstract class Carcharhiniformes : Chondrichthyes, ICarcharhiniformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Carcharhiniformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 30483;
