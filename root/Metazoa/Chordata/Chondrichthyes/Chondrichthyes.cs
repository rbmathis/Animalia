...
/// <summary>
/// Abstract class for Chondrichthyes (class).
/// NCBI TaxId: 7777
/// </summary>
public abstract class Chondrichthyes : Chordata, IChondrichthyes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Chondrichthyes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "class";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 7777;
