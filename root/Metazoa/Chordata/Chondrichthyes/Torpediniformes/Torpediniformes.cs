...
/// <summary>
/// Abstract class for Torpediniformes (order).
/// NCBI TaxId: 117888
/// </summary>
public abstract class Torpediniformes : Chondrichthyes, ITorpediniformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Torpediniformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 117888;
