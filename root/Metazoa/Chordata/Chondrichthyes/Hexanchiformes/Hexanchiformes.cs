...
namespace AnimalKingdom.root.Metazoa.Chordata.Chondrichthyes.Hexanchiformes;

/// <summary>
/// Abstract class for Hexanchiformes (order).
/// NCBI TaxId: 30495
/// </summary>
public abstract class Hexanchiformes : Chondrichthyes, IHexanchiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Hexanchiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 30495;
