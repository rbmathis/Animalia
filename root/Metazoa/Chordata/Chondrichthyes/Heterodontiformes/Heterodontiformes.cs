...
namespace AnimalKingdom.root.Metazoa.Chordata.Chondrichthyes.Heterodontiformes;

/// <summary>
/// Abstract class for Heterodontiformes (order).
/// NCBI TaxId: 40667
/// </summary>
public abstract class Heterodontiformes : Chondrichthyes, IHeterodontiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Heterodontiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 40667;
