...
namespace AnimalKingdom.root.Metazoa.Chordata.Chondrichthyes.Rhinopristiformes;

/// <summary>
/// Abstract class for Rhinopristiformes (order).
/// NCBI TaxId: 117887
/// </summary>
public abstract class Rhinopristiformes : Chondrichthyes, IRhinopristiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Rhinopristiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 117887;
