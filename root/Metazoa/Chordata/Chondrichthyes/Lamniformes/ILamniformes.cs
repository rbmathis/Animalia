namespace AnimalKingdom.root.Metazoa.Chordata.Chondrichthyes.Lamniformes;

/// <summary>
/// Interface defining characteristics of Lamniformes (order).
/// </summary>
public interface ILamniformes
{
    /// <inheritdoc />
