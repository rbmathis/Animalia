...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Strigiformes;

/// <summary>
/// Abstract class for Strigiformes (order).
/// NCBI TaxId: 30458
/// </summary>
public abstract class Strigiformes : Aves, IStrigiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Strigiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 30458;
