...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Tinamiformes;

/// <summary>
/// Abstract class for Tinamiformes (order).
/// NCBI TaxId: 8802
/// </summary>
public abstract class Tinamiformes : Aves, ITinamiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Tinamiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8802;
