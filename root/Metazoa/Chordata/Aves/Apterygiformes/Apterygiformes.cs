...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Apterygiformes;

/// <summary>
/// Abstract class for Apterygiformes (order).
/// NCBI TaxId: 8819
/// </summary>
public abstract class Apterygiformes : Aves, IApterygiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Apterygiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8819;
