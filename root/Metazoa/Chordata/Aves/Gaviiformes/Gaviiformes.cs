...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Gaviiformes;

/// <summary>
/// Abstract class for Gaviiformes (order).
/// NCBI TaxId: 30411
/// </summary>
public abstract class Gaviiformes : Aves, IGaviiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Gaviiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 30411;
