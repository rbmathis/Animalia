...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Leptosomiformes;

/// <summary>
/// Abstract class for Leptosomiformes (order).
/// NCBI TaxId: 3466517
/// </summary>
public abstract class Leptosomiformes : Aves, ILeptosomiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Leptosomiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 3466517;
