...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Psittaciformes;

/// <summary>
/// Abstract class for Psittaciformes (order).
/// NCBI TaxId: 9223
/// </summary>
public abstract class Psittaciformes : Aves, IPsittaciformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Psittaciformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9223;
