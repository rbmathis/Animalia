...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Columbiformes;

/// <summary>
/// Abstract class for Columbiformes (order).
/// NCBI TaxId: 8929
/// </summary>
public abstract class Columbiformes : Aves, IColumbiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Columbiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8929;
