...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Musophagiformes;

/// <summary>
/// Abstract class for Musophagiformes (order).
/// NCBI TaxId: 56301
/// </summary>
public abstract class Musophagiformes : Aves, IMusophagiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Musophagiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 56301;
