...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Galliformes;

/// <summary>
/// Abstract class for Galliformes (order).
/// NCBI TaxId: 8976
/// </summary>
public abstract class Galliformes : Aves, IGalliformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Galliformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8976;
