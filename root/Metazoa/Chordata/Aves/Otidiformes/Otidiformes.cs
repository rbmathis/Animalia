...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Otidiformes;

/// <summary>
/// Abstract class for Otidiformes (order).
/// NCBI TaxId: 3073807
/// </summary>
public abstract class Otidiformes : Aves, IOtidiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Otidiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 3073807;
