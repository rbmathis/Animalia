...
/// <summary>
/// Abstract class for Rheiformes (order).
/// NCBI TaxId: 8792
/// </summary>
public abstract class Rheiformes : Aves, IRheiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Rheiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8792;
