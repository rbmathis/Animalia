...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Falconiformes;

/// <summary>
/// Abstract class for Falconiformes (order).
/// NCBI TaxId: 8948
/// </summary>
public abstract class Falconiformes : Aves, IFalconiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Falconiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8948;
