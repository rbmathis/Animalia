...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Procellariiformes;

/// <summary>
/// Abstract class for Procellariiformes (order).
/// NCBI TaxId: 30449
/// </summary>
public abstract class Procellariiformes : Aves, IProcellariiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Procellariiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 30449;
