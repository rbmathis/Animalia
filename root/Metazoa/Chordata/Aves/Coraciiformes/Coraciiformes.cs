...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Coraciiformes;

/// <summary>
/// Abstract class for Coraciiformes (order).
/// NCBI TaxId: 8936
/// </summary>
public abstract class Coraciiformes : Aves, ICoraciiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Coraciiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8936;
