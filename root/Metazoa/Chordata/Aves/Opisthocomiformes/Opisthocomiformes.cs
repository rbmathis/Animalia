...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Opisthocomiformes;

/// <summary>
/// Abstract class for Opisthocomiformes (order).
/// NCBI TaxId: 30416
/// </summary>
public abstract class Opisthocomiformes : Aves, IOpisthocomiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Opisthocomiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 30416;
