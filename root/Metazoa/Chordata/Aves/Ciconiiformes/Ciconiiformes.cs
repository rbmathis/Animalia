...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Ciconiiformes;

/// <summary>
/// Abstract class for Ciconiiformes (order).
/// NCBI TaxId: 8920
/// </summary>
public abstract class Ciconiiformes : Aves, ICiconiiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Ciconiiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8920;
