...
/// <summary>
/// Abstract class for Trogoniformes (order).
/// NCBI TaxId: 56308
/// </summary>
public abstract class Trogoniformes : Aves, ITrogoniformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Trogoniformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 56308;
