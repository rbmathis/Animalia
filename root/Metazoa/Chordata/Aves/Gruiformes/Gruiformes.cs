...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Gruiformes;

/// <summary>
/// Abstract class for Gruiformes (order).
/// NCBI TaxId: 9108
/// </summary>
public abstract class Gruiformes : Aves, IGruiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Gruiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9108;
