...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Eurypygiformes;

/// <summary>
/// Abstract class for Eurypygiformes (order).
/// NCBI TaxId: 3073798
/// </summary>
public abstract class Eurypygiformes : Aves, IEurypygiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Eurypygiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 3073798;
