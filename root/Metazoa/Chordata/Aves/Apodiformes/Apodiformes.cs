...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Apodiformes;

/// <summary>
/// Abstract class for Apodiformes (order).
/// NCBI TaxId: 8892
/// </summary>
public abstract class Apodiformes : Aves, IApodiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Apodiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8892;
