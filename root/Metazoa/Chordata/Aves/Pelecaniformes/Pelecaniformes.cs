...
/// <summary>
/// Abstract class for Pelecaniformes (order).
/// NCBI TaxId: 9205
/// </summary>
public abstract class Pelecaniformes : Aves, IPelecaniformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Pelecaniformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9205;
