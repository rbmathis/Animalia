...
/// <summary>
/// Abstract class for Bucerotiformes (order).
/// NCBI TaxId: 57379
/// </summary>
public abstract class Bucerotiformes : Aves, IBucerotiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Bucerotiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 57379;
