...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Mesitornithiformes;

/// <summary>
/// Abstract class for Mesitornithiformes (order).
/// NCBI TaxId: 3073801
/// </summary>
public abstract class Mesitornithiformes : Aves, IMesitornithiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Mesitornithiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 3073801;
