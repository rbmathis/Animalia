...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Nyctibiiformes;

/// <summary>
/// Abstract class for Nyctibiiformes (order).
/// NCBI TaxId: 3466518
/// </summary>
public abstract class Nyctibiiformes : Aves, INyctibiiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Nyctibiiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 3466518;
