...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Charadriiformes;

/// <summary>
/// Abstract class for Charadriiformes (order).
/// NCBI TaxId: 8906
/// </summary>
public abstract class Charadriiformes : Aves, ICharadriiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Charadriiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8906;
