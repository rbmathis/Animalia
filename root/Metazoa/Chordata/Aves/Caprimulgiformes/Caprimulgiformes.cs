...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Caprimulgiformes;

/// <summary>
/// Abstract class for Caprimulgiformes (order).
/// NCBI TaxId: 8902
/// </summary>
public abstract class Caprimulgiformes : Aves, ICaprimulgiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Caprimulgiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8902;
