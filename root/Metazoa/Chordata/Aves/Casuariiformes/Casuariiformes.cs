...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Casuariiformes;

/// <summary>
/// Abstract class for Casuariiformes (order).
/// NCBI TaxId: 8784
/// </summary>
public abstract class Casuariiformes : Aves, ICasuariiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Casuariiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8784;
