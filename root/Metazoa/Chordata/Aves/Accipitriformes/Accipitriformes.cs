...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Accipitriformes;

/// <summary>
/// Abstract class for Accipitriformes (order).
/// NCBI TaxId: 2558200
/// </summary>
public abstract class Accipitriformes : Aves, IAccipitriformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Accipitriformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 2558200;
