...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Anseriformes;

/// <summary>
/// Abstract class for Anseriformes (order).
/// NCBI TaxId: 8826
/// </summary>
public abstract class Anseriformes : Aves, IAnseriformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Anseriformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8826;
