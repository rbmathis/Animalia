...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Cariamiformes;

/// <summary>
/// Abstract class for Cariamiformes (order).
/// NCBI TaxId: 1956187
/// </summary>
public abstract class Cariamiformes : Aves, ICariamiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Cariamiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1956187;
