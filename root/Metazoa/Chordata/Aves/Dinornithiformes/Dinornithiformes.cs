...
/// <summary>
/// Abstract class for Dinornithiformes (order).
/// NCBI TaxId: 8808
/// </summary>
public abstract class Dinornithiformes : Aves, IDinornithiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Dinornithiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8808;
