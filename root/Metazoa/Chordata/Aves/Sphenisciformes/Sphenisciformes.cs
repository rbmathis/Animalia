...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Sphenisciformes;

/// <summary>
/// Abstract class for Sphenisciformes (order).
/// NCBI TaxId: 9230
/// </summary>
public abstract class Sphenisciformes : Aves, ISphenisciformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Sphenisciformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9230;
