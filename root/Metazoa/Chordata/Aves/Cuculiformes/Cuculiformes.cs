...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Cuculiformes;

/// <summary>
/// Abstract class for Cuculiformes (order).
/// NCBI TaxId: 8940
/// </summary>
public abstract class Cuculiformes : Aves, ICuculiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Cuculiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8940;
