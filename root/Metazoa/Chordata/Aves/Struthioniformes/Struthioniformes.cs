...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Struthioniformes;

/// <summary>
/// Abstract class for Struthioniformes (order).
/// NCBI TaxId: 8798
/// </summary>
public abstract class Struthioniformes : Aves, IStruthioniformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Struthioniformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8798;
