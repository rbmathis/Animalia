...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Podicipediformes;

/// <summary>
/// Abstract class for Podicipediformes (order).
/// NCBI TaxId: 30447
/// </summary>
public abstract class Podicipediformes : Aves, IPodicipediformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Podicipediformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 30447;
