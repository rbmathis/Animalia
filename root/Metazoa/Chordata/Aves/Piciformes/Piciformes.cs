...
/// <summary>
/// Abstract class for Piciformes (order).
/// NCBI TaxId: 9219
/// </summary>
public abstract class Piciformes : Aves, IPiciformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Piciformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9219;
