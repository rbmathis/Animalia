...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Suliformes;

/// <summary>
/// Abstract class for Suliformes (order).
/// NCBI TaxId: 3073854
/// </summary>
public abstract class Suliformes : Aves, ISuliformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Suliformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 3073854;
