...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Phaethontiformes;

/// <summary>
/// Abstract class for Phaethontiformes (order).
/// NCBI TaxId: 3073797
/// </summary>
public abstract class Phaethontiformes : Aves, IPhaethontiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Phaethontiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 3073797;
