...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Passeriformes;

/// <summary>
/// Abstract class for Passeriformes (order).
/// NCBI TaxId: 9126
/// </summary>
public abstract class Passeriformes : Aves, IPasseriformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Passeriformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 9126;
