...
/// <summary>
/// Abstract class for Coliiformes (order).
/// NCBI TaxId: 57384
/// </summary>
public abstract class Coliiformes : Aves, IColiiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Coliiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 57384;
