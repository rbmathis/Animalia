...
namespace AnimalKingdom.root.Metazoa.Chordata.Aves.Pterocliformes;

/// <summary>
/// Abstract class for Pterocliformes (order).
/// NCBI TaxId: 3073800
/// </summary>
public abstract class Pterocliformes : Aves, IPterocliformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Pterocliformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 3073800;
