...
/// <summary>
/// Abstract class for Ceratodontiformes (order).
/// NCBI TaxId: 2823314
/// </summary>
public abstract class Ceratodontiformes : Chordata, ICeratodontiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Ceratodontiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 2823314;
