...
namespace AnimalKingdom.root.Metazoa.Chordata.Coelacanthiformes;

/// <summary>
/// Abstract class for Coelacanthiformes (order).
/// NCBI TaxId: 7894
/// </summary>
public abstract class Coelacanthiformes : Chordata, ICoelacanthiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Coelacanthiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 7894;
