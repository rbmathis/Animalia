...
namespace AnimalKingdom.root.Metazoa.Chordata.Amphibia.Anura;

/// <summary>
/// Abstract class for Anura (order).
/// NCBI TaxId: 8342
/// </summary>
public abstract class Anura : Amphibia, IAnura
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Anura";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8342;
