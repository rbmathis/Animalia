...
/// <summary>
/// Abstract class for Amphibia (class).
/// NCBI TaxId: 8292
/// </summary>
public abstract class Amphibia : Chordata, IAmphibia
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Amphibia";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "class";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8292;
