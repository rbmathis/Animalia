...
/// <summary>
/// Abstract class for Myxini (class).
/// NCBI TaxId: 117565
/// </summary>
public abstract class Myxini : Chordata, IMyxini
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Myxini";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "class";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 117565;
