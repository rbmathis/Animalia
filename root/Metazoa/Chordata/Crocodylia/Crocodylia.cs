...
namespace AnimalKingdom.root.Metazoa.Chordata.Crocodylia;

/// <summary>
/// Abstract class for Crocodylia (order).
/// NCBI TaxId: 1294634
/// </summary>
public abstract class Crocodylia : Chordata, ICrocodylia
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Crocodylia";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1294634;
