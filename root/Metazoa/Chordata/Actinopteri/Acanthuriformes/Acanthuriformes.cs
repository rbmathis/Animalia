...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Acanthuriformes;

/// <summary>
/// Abstract class for Acanthuriformes (order).
/// NCBI TaxId: 1489937
/// </summary>
public abstract class Acanthuriformes : Actinopteri, IAcanthuriformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Acanthuriformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489937;
