...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Mugiliformes;

/// <summary>
/// Abstract class for Mugiliformes (order).
/// NCBI TaxId: 41872
/// </summary>
public abstract class Mugiliformes : Actinopteri, IMugiliformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Mugiliformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 41872;
