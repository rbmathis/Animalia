...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Lobotiformes;

/// <summary>
/// Abstract class for Lobotiformes (order).
/// NCBI TaxId: 1489929
/// </summary>
public abstract class Lobotiformes : Actinopteri, ILobotiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Lobotiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489929;
