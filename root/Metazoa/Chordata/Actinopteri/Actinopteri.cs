...
/// <summary>
/// Abstract class for Actinopteri (class).
/// NCBI TaxId: 186623
/// </summary>
public abstract class Actinopteri : Chordata, IActinopteri
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Actinopteri";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "class";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 186623;
