...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Alepocephaliformes;

/// <summary>
/// Abstract class for Alepocephaliformes (order).
/// NCBI TaxId: 1489486
/// </summary>
public abstract class Alepocephaliformes : Actinopteri, IAlepocephaliformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Alepocephaliformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489486;
