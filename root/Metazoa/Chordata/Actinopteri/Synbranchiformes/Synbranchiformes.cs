...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Synbranchiformes;

/// <summary>
/// Abstract class for Synbranchiformes (order).
/// NCBI TaxId: 43697
/// </summary>
public abstract class Synbranchiformes : Actinopteri, ISynbranchiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Synbranchiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 43697;
