...
/// <summary>
/// Abstract class for Lutjaniformes (order).
/// NCBI TaxId: 2024539
/// </summary>
public abstract class Lutjaniformes : Actinopteri, ILutjaniformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Lutjaniformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 2024539;
