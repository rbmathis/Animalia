...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Lampriformes;

/// <summary>
/// Abstract class for Lampriformes (order).
/// NCBI TaxId: 81386
/// </summary>
public abstract class Lampriformes : Actinopteri, ILampriformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Lampriformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 81386;
