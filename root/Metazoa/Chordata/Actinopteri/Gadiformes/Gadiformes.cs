...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Gadiformes;

/// <summary>
/// Abstract class for Gadiformes (order).
/// NCBI TaxId: 8043
/// </summary>
public abstract class Gadiformes : Actinopteri, IGadiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Gadiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8043;
