...
/// <summary>
/// Abstract class for Centrarchiformes (order).
/// NCBI TaxId: 1489940
/// </summary>
public abstract class Centrarchiformes : Actinopteri, ICentrarchiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Centrarchiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489940;
