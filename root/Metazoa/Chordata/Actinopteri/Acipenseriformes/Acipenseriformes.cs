...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Acipenseriformes;

/// <summary>
/// Abstract class for Acipenseriformes (order).
/// NCBI TaxId: 7899
/// </summary>
public abstract class Acipenseriformes : Actinopteri, IAcipenseriformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Acipenseriformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 7899;
