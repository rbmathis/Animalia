...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Batrachoidiformes;

/// <summary>
/// Abstract class for Batrachoidiformes (order).
/// NCBI TaxId: 8064
/// </summary>
public abstract class Batrachoidiformes : Actinopteri, IBatrachoidiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Batrachoidiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8064;
