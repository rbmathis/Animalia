...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Osmeriformes;

/// <summary>
/// Abstract class for Osmeriformes (order).
/// NCBI TaxId: 41711
/// </summary>
public abstract class Osmeriformes : Actinopteri, IOsmeriformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Osmeriformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 41711;
