...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Lepidogalaxiiformes;

/// <summary>
/// Abstract class for Lepidogalaxiiformes (order).
/// NCBI TaxId: 1489795
/// </summary>
public abstract class Lepidogalaxiiformes : Actinopteri, ILepidogalaxiiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Lepidogalaxiiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489795;
