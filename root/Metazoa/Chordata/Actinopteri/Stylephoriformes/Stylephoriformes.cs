...
/// <summary>
/// Abstract class for Stylephoriformes (order).
/// NCBI TaxId: 1489837
/// </summary>
public abstract class Stylephoriformes : Actinopteri, IStylephoriformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Stylephoriformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489837;
