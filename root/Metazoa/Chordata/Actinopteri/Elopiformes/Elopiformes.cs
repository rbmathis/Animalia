...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Elopiformes;

/// <summary>
/// Abstract class for Elopiformes (order).
/// NCBI TaxId: 7925
/// </summary>
public abstract class Elopiformes : Actinopteri, IElopiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Elopiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 7925;
