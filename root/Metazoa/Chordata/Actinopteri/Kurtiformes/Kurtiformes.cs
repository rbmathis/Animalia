...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Kurtiformes;

/// <summary>
/// Abstract class for Kurtiformes (order).
/// NCBI TaxId: 1489876
/// </summary>
public abstract class Kurtiformes : Actinopteri, IKurtiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Kurtiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489876;
