...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Polymixiiformes;

/// <summary>
/// Abstract class for Polymixiiformes (order).
/// NCBI TaxId: 81382
/// </summary>
public abstract class Polymixiiformes : Actinopteri, IPolymixiiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Polymixiiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 81382;
