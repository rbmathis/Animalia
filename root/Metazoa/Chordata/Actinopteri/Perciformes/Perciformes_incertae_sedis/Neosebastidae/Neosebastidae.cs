...
/// <summary>
/// Abstract class for Neosebastidae (family).
/// NCBI TaxId: 274689
/// </summary>
public abstract class Neosebastidae : Perciformes_incertae_sedis, INeosebastidae
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Neosebastidae";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "family";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 274689;
