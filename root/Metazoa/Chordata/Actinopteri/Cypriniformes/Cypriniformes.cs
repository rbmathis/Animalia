...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Cypriniformes;

/// <summary>
/// Abstract class for Cypriniformes (order).
/// NCBI TaxId: 7952
/// </summary>
public abstract class Cypriniformes : Actinopteri, ICypriniformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Cypriniformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 7952;
