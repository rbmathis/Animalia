...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Esociformes;

/// <summary>
/// Abstract class for Esociformes (order).
/// NCBI TaxId: 8007
/// </summary>
public abstract class Esociformes : Actinopteri, IEsociformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Esociformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8007;
