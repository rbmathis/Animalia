...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Blenniiformes;

/// <summary>
/// Abstract class for Blenniiformes (order).
/// NCBI TaxId: 1489921
/// </summary>
public abstract class Blenniiformes : Actinopteri, IBlenniiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Blenniiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489921;
