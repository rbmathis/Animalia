...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Scombriformes;

/// <summary>
/// Abstract class for Scombriformes (order).
/// NCBI TaxId: 1489894
/// </summary>
public abstract class Scombriformes : Actinopteri, IScombriformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Scombriformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489894;
