...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Spariformes;

/// <summary>
/// Abstract class for Spariformes (order).
/// NCBI TaxId: 1489931
/// </summary>
public abstract class Spariformes : Actinopteri, ISpariformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Spariformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489931;
