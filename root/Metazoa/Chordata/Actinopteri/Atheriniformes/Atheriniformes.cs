...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Atheriniformes;

/// <summary>
/// Abstract class for Atheriniformes (order).
/// NCBI TaxId: 8075
/// </summary>
public abstract class Atheriniformes : Actinopteri, IAtheriniformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Atheriniformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8075;
