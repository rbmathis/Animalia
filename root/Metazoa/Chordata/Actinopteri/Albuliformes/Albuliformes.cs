...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Albuliformes;

/// <summary>
/// Abstract class for Albuliformes (order).
/// NCBI TaxId: 54906
/// </summary>
public abstract class Albuliformes : Actinopteri, IAlbuliformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Albuliformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 54906;
