...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Hiodontiformes;

/// <summary>
/// Abstract class for Hiodontiformes (order).
/// NCBI TaxId: 1489345
/// </summary>
public abstract class Hiodontiformes : Actinopteri, IHiodontiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Hiodontiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489345;
