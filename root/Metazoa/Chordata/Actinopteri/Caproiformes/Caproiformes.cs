...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Caproiformes;

/// <summary>
/// Abstract class for Caproiformes (order).
/// NCBI TaxId: 2024527
/// </summary>
public abstract class Caproiformes : Actinopteri, ICaproiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Caproiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 2024527;
