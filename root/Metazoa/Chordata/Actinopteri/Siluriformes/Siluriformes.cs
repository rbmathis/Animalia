...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Siluriformes;

/// <summary>
/// Abstract class for Siluriformes (order).
/// NCBI TaxId: 7995
/// </summary>
public abstract class Siluriformes : Actinopteri, ISiluriformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Siluriformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 7995;
