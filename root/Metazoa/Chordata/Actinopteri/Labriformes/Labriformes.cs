...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Labriformes;

/// <summary>
/// Abstract class for Labriformes (order).
/// NCBI TaxId: 1489928
/// </summary>
public abstract class Labriformes : Actinopteri, ILabriformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Labriformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489928;
