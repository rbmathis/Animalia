...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Myctophiformes;

/// <summary>
/// Abstract class for Myctophiformes (order).
/// NCBI TaxId: 68514
/// </summary>
public abstract class Myctophiformes : Actinopteri, IMyctophiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Myctophiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 68514;
