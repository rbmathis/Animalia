namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Clupeiformes;

/// <summary>
/// Interface defining characteristics of Clupeiformes (order).
/// </summary>
public interface IClupeiformes
{
    /// <inheritdoc />
