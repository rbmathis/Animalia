...
/// <summary>
/// Abstract class for Clupeiformes (order).
/// NCBI TaxId: 32446
/// </summary>
public abstract class Clupeiformes : Actinopteri, IClupeiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Clupeiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 32446;
