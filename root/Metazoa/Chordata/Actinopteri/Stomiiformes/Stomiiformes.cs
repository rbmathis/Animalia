...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Stomiiformes;

/// <summary>
/// Abstract class for Stomiiformes (order).
/// NCBI TaxId: 48438
/// </summary>
public abstract class Stomiiformes : Actinopteri, IStomiiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Stomiiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 48438;
