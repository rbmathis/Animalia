...
/// <summary>
/// Abstract class for Ophidiiformes (order).
/// NCBI TaxId: 94929
/// </summary>
public abstract class Ophidiiformes : Actinopteri, IOphidiiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Ophidiiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 94929;
