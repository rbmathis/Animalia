...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Gerreiformes;

/// <summary>
/// Abstract class for Gerreiformes (order).
/// NCBI TaxId: 2024538
/// </summary>
public abstract class Gerreiformes : Actinopteri, IGerreiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Gerreiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 2024538;
