...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Trachichthyiformes;

/// <summary>
/// Abstract class for Trachichthyiformes (order).
/// NCBI TaxId: 2558152
/// </summary>
public abstract class Trachichthyiformes : Actinopteri, ITrachichthyiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Trachichthyiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 2558152;
