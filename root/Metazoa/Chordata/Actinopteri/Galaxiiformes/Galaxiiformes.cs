...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Galaxiiformes;

/// <summary>
/// Abstract class for Galaxiiformes (order).
/// NCBI TaxId: 51241
/// </summary>
public abstract class Galaxiiformes : Actinopteri, IGalaxiiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Galaxiiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 51241;
