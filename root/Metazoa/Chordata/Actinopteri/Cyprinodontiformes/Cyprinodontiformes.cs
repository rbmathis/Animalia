...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Cyprinodontiformes;

/// <summary>
/// Abstract class for Cyprinodontiformes (order).
/// NCBI TaxId: 28738
/// </summary>
public abstract class Cyprinodontiformes : Actinopteri, ICyprinodontiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Cyprinodontiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 28738;
