...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Cichliformes;

/// <summary>
/// Abstract class for Cichliformes (order).
/// NCBI TaxId: 1489911
/// </summary>
public abstract class Cichliformes : Actinopteri, ICichliformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Cichliformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489911;
