...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Carangiformes;

/// <summary>
/// Abstract class for Carangiformes (order).
/// NCBI TaxId: 1489907
/// </summary>
public abstract class Carangiformes : Actinopteri, ICarangiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Carangiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489907;
