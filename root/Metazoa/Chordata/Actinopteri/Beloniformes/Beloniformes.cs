...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Beloniformes;

/// <summary>
/// Abstract class for Beloniformes (order).
/// NCBI TaxId: 76071
/// </summary>
public abstract class Beloniformes : Actinopteri, IBeloniformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Beloniformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 76071;
