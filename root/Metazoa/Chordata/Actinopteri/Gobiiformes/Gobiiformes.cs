...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Gobiiformes;

/// <summary>
/// Abstract class for Gobiiformes (order).
/// NCBI TaxId: 1489878
/// </summary>
public abstract class Gobiiformes : Actinopteri, IGobiiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Gobiiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489878;
