...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Amiiformes;

/// <summary>
/// Abstract class for Amiiformes (order).
/// NCBI TaxId: 7921
/// </summary>
public abstract class Amiiformes : Actinopteri, IAmiiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Amiiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 7921;
