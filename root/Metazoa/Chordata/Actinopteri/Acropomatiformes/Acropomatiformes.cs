...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Acropomatiformes;

/// <summary>
/// Abstract class for Acropomatiformes (order).
/// NCBI TaxId: 3051910
/// </summary>
public abstract class Acropomatiformes : Actinopteri, IAcropomatiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Acropomatiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 3051910;
