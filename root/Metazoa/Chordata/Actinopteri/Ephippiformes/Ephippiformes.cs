...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Ephippiformes;

/// <summary>
/// Abstract class for Ephippiformes (order).
/// NCBI TaxId: 1489930
/// </summary>
public abstract class Ephippiformes : Actinopteri, IEphippiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Ephippiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489930;
