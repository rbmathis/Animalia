...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Semionotiformes;

/// <summary>
/// Abstract class for Semionotiformes (order).
/// NCBI TaxId: 7914
/// </summary>
public abstract class Semionotiformes : Actinopteri, ISemionotiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Semionotiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 7914;
