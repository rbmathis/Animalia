...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Aulopiformes;

/// <summary>
/// Abstract class for Aulopiformes (order).
/// NCBI TaxId: 68510
/// </summary>
public abstract class Aulopiformes : Actinopteri, IAulopiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Aulopiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 68510;
