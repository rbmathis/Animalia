...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Beryciformes;

/// <summary>
/// Abstract class for Beryciformes (order).
/// NCBI TaxId: 8277
/// </summary>
public abstract class Beryciformes : Actinopteri, IBeryciformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Beryciformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8277;
