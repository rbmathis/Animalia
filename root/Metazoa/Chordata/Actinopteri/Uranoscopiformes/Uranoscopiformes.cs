...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Uranoscopiformes;

/// <summary>
/// Abstract class for Uranoscopiformes (order).
/// NCBI TaxId: 1489926
/// </summary>
public abstract class Uranoscopiformes : Actinopteri, IUranoscopiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Uranoscopiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489926;
