...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Argentiniformes;

/// <summary>
/// Abstract class for Argentiniformes (order).
/// NCBI TaxId: 134613
/// </summary>
public abstract class Argentiniformes : Actinopteri, IArgentiniformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Argentiniformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 134613;
