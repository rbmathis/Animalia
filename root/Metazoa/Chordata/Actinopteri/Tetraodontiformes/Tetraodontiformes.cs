...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Tetraodontiformes;

/// <summary>
/// Abstract class for Tetraodontiformes (order).
/// NCBI TaxId: 31022
/// </summary>
public abstract class Tetraodontiformes : Actinopteri, ITetraodontiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Tetraodontiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 31022;
