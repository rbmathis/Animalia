...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Characiformes;

/// <summary>
/// Abstract class for Characiformes (order).
/// NCBI TaxId: 7991
/// </summary>
public abstract class Characiformes : Actinopteri, ICharaciformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Characiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 7991;
