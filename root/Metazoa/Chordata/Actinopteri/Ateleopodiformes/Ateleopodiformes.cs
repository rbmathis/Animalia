...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Ateleopodiformes;

/// <summary>
/// Abstract class for Ateleopodiformes (order).
/// NCBI TaxId: 143303
/// </summary>
public abstract class Ateleopodiformes : Actinopteri, IAteleopodiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Ateleopodiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 143303;
