...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Holocentriformes;

/// <summary>
/// Abstract class for Holocentriformes (order).
/// NCBI TaxId: 1490028
/// </summary>
public abstract class Holocentriformes : Actinopteri, IHolocentriformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Holocentriformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1490028;
