...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Pempheriformes;

/// <summary>
/// Abstract class for Pempheriformes (order).
/// NCBI TaxId: 1489939
/// </summary>
public abstract class Pempheriformes : Actinopteri, IPempheriformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Pempheriformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489939;
