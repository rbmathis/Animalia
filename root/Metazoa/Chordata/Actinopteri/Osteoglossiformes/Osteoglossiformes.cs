...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Osteoglossiformes;

/// <summary>
/// Abstract class for Osteoglossiformes (order).
/// NCBI TaxId: 41712
/// </summary>
public abstract class Osteoglossiformes : Actinopteri, IOsteoglossiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Osteoglossiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 41712;
