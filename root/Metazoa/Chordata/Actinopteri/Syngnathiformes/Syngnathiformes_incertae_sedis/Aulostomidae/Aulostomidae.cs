...
/// <summary>
/// Abstract class for Aulostomidae (family).
/// NCBI TaxId: 150446
/// </summary>
public abstract class Aulostomidae : Syngnathiformes_incertae_sedis, IAulostomidae
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Aulostomidae";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "family";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 150446;
