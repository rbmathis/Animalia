...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Syngnathiformes;

/// <summary>
/// Abstract class for Syngnathiformes (order).
/// NCBI TaxId: 129912
/// </summary>
public abstract class Syngnathiformes : Actinopteri, ISyngnathiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Syngnathiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 129912;
