...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Salmoniformes;

/// <summary>
/// Abstract class for Salmoniformes (order).
/// NCBI TaxId: 8006
/// </summary>
public abstract class Salmoniformes : Actinopteri, ISalmoniformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Salmoniformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8006;
