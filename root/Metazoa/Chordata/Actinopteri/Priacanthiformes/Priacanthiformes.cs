...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Priacanthiformes;

/// <summary>
/// Abstract class for Priacanthiformes (order).
/// NCBI TaxId: 2024536
/// </summary>
public abstract class Priacanthiformes : Actinopteri, IPriacanthiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Priacanthiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 2024536;
