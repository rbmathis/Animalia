...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Gymnotiformes;

/// <summary>
/// Abstract class for Gymnotiformes (order).
/// NCBI TaxId: 8002
/// </summary>
public abstract class Gymnotiformes : Actinopteri, IGymnotiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Gymnotiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8002;
