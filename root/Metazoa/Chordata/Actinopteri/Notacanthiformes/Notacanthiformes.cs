...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Notacanthiformes;

/// <summary>
/// Abstract class for Notacanthiformes (order).
/// NCBI TaxId: 143896
/// </summary>
public abstract class Notacanthiformes : Actinopteri, INotacanthiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Notacanthiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 143896;
