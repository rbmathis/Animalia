...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Zeiformes;

/// <summary>
/// Abstract class for Zeiformes (order).
/// NCBI TaxId: 31097
/// </summary>
public abstract class Zeiformes : Actinopteri, IZeiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Zeiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 31097;
