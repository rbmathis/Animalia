...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Gonorynchiformes;

/// <summary>
/// Abstract class for Gonorynchiformes (order).
/// NCBI TaxId: 29140
/// </summary>
public abstract class Gonorynchiformes : Actinopteri, IGonorynchiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Gonorynchiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 29140;
