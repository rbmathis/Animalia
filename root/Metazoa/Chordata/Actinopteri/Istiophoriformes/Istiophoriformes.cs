...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Istiophoriformes;

/// <summary>
/// Abstract class for Istiophoriformes (order).
/// NCBI TaxId: 1489906
/// </summary>
public abstract class Istiophoriformes : Actinopteri, IIstiophoriformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Istiophoriformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 1489906;
