...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Lophiiformes;

/// <summary>
/// Abstract class for Lophiiformes (order).
/// NCBI TaxId: 8070
/// </summary>
public abstract class Lophiiformes : Actinopteri, ILophiiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Lophiiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 8070;
