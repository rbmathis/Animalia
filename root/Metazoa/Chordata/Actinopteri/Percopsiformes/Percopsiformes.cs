...
namespace AnimalKingdom.root.Metazoa.Chordata.Actinopteri.Percopsiformes;

/// <summary>
/// Abstract class for Percopsiformes (order).
/// NCBI TaxId: 81377
/// </summary>
public abstract class Percopsiformes : Actinopteri, IPercopsiformes
{
    /// <summary>Gets the scientific name.</summary>
    public override string ScientificName => "Percopsiformes";

    /// <summary>Gets the taxonomic rank.</summary>
    public override string TaxonomicRank => "order";

    /// <summary>Gets the NCBI Taxonomy ID.</summary>
    public override int TaxId => 81377;
